...
public class WekaUtilsProcessing extends WekaUtils {
	...
	public static void main(String[] args) {
		...
		//			e.printStackTrace();
		//		}
		// previous just to make training
		...
		//		System.out.println(instances.toSummaryString());
		//		try {
		//			// rf50 fails in the GUI, OK here
		////			RandomForest rf50 = new RandomForest();
		////			rf50.setNumTrees(50);
		//			LibSVM svm = new LibSVM();
		//			Evaluation evaluation = new Evaluation(instances);
		//			evaluation.crossValidateModel(svm,
		//                    instances,
		//                    10,
		//                    new Random(1));
		//			//evaluation.evaluateModel(svm, instances);
		//			System.out.println("SVM y prediction, no coords:");
		//			System.out.println(evaluation.toSummaryString());
		//		} catch (Exception e) {
		//			e.printStackTrace();
		//		}
		...
		//		// 20141110
		//		// run all the index based meta-predictions w/o the coordinates
		//		System.out.println("Meta prediction of j:");
		//		System.out.println();
		//		// Classifiers.  All defaults.
		//		Classifier[] cls = new Classifier[9];
		//		OneR oneR = new OneR();
		//		cls[0] = oneR;
		//		RandomForest rf10 = new RandomForest();
		//		rf10.setNumTrees(10);
		...
		//				for (int n = 0; n < folds; n++) {
		//					Instances train = randData.trainCV(folds, n, rand);
		//					//System.out.println(train.toSummaryString()); // 90%
		//					Instances test = randData.testCV(folds, n);
		//					//System.out.println(test.toSummaryString()); // 10%
		//					
		//					// make meta training **************************************************
		//					train.setClassIndex(0); // "interpreted"
		//					Attribute[] predictors = {
		//							train.attribute("J48"),
		//							train.attribute("MLC"),
		//							train.attribute("RF"),
		...
		//					Instances metatrain = makeTraining(train, predictors, costs);
		//					// remove the old class index, the true response
		//					metatrain.deleteAttributeAt(0); // "interpreted"
		//					// set the new class index to the level1 response
		//					metatrain.setClassIndex(metatrain.numAttributes()-1);
		//					Attribute classAtt = metatrain.classAttribute(); // "response"
		//					
		...
		//
		//					// prediction in the level0 space *****************************************
		//					metatest.setClassIndex(0); // "interpreted"
		//					Attribute level1response = test.attribute("response");
		//					MetaAttributeClassifier classy = new MetaAttributeClassifier(level1response);
		//					Evaluation evaluation = new Evaluation(metatest);
		//					evaluation.evaluateModel(classy, metatest);
		//					//System.out.println(evaluation.toSummaryString("=== fold-" + n + " Cross-validation ===", false));
		//					accuracy+=evaluation.pctCorrect();
		//					accuracies[n] = evaluation.pctCorrect();
		//				} // end folds
		//				
		//				System.out.println("\t accuracy: "+(accuracy/(double)folds));
		//				System.out.println(Arrays.toString(accuracies));
		//				System.out.println("\t sd: "+Math.sqrt(weka.core.Utils.variance(accuracies)));
		//				
		//			} catch (Exception e) {
		//				e.printStackTrace();
		//			}
...
//				try {
//					Evaluation cv = new Evaluation(randData);
//					cv.crossValidateModel(cl, randData, 10, new Random(1));
//					System.out.print(myFormatter.format(cv.pctCorrect())+",\t");
//				} catch (Exception e1) {
//					e1.printStackTrace();
//				}
//
...
//					try {
//						Instances train = randData.trainCV(folds, k, rand);
//						//System.out.println(train.toSummaryString()); // 90%
//						Instances test = randData.testCV(folds, k);
//						//System.out.println(test.toSummaryString()); // 10%
//
//						// make meta training **************************************************
//						train.setClassIndex(2); // "interpreted"
...
//						//System.out.println(evaluation.toSummaryString("=== fold-" + n + " Cross-validation ===", false));
//						accuracy+=evaluation.pctCorrect();
//						accuracies[k] = evaluation.pctCorrect();
		//					} catch (Exception e) {
		//						e.printStackTrace();
		//					}
		//				} // end folds
		//				
		//				System.out.printf(myFormatter.format(accuracy/(double)folds)+",\t");
		//				System.out.printf(myFormatter.format(Math.sqrt(weka.core.Utils.variance(accuracies)))+"\n");
		//				
		//			} // end learning size
...
//				System.out.print(n+",\t");
//				Instances randData = new Instances(instances, 0, n);   // subset of training
//				randData.setClassIndex(2); // "interpretation"
//				
//				// prediction of class
//				DecimalFormat myFormatter = new DecimalFormat("##.###");
//				try {
//					Evaluation eval = new Evaluation(randData);
//					cl.buildClassifier(randData);
//					eval.evaluateModel(cl, randData);
...
//
//					// make meta training **************************************************
//					randData.setClassIndex(2); // "interpreted"
//					Attribute[] predictors = {
//							randData.attribute("J48"),
//							randData.attribute("MLC"),
//							randData.attribute("RF"),
//							randData.attribute("SVM"),
//							randData.attribute("Seg"),
//							randData.attribute("Agg"),
//					};
//					double[] costs = new double[predictors.length];
//					int a=0;
//					for (Attribute att : predictors) {
...
//						evaluation.evaluateModel(classy, randData);
//						costs[a] = evaluation.errorRate();
//						a++;
//					}
//					Instances metatrain = makeTraining(randData, predictors, costs);
//					Instances metatest = new Instances(metatrain);
//
//					// remove the old class index, the true response
//					metatrain.deleteAttributeAt(2); // "interpreted"
//					// set the new class index to the level1 response
...
//					fc.setFilter(rm);
//
//					// the metatest instances already have predicted best base labels
//					metatest.setClassIndex(2); // "interpreted"
//					Attribute level1response = metatest.attribute("response");
//					MetaAttributeClassifier classy = new MetaAttributeClassifier(level1response);
//					Evaluation evaluation = new Evaluation(metatest);
//					evaluation.evaluateModel(classy, metatest);
//
//					System.out.printf(myFormatter.format(evaluation.pctCorrect())+"\n");
		//
		//				} catch (Exception e) {
		//					e.printStackTrace();
		//				}
